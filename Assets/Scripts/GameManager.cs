...
//		timeText.text = "Current Time: " + currentTime.ToString ("0.00");	//显示已用时间
		...
		case GameState.Playing:
			if (currentScore >= TargetScore) {
				...
				timeText.text = "Current Time: " + currentTime.ToString ("0.00");
...
//			break;
	...
	void EditGameOverCanvas(){
		...
		case "1":
			gameMessage.text = "First Place！";
			break;
		case "2":
			gameMessage.text = "Second Place！";
			break;
		case "3":
			gameMessage.text = "Third Place！";
			break;
		default:
			gameMessage.text = "";
			break;
